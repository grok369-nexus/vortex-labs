    ...
    <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[0.8fr_1.2fr]">
      ...
      <form onSubmit={handleSubmit} className="dashboard-card space-y-5">
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <label className="text-sm text-zinc-300">Email<input required type="email" name="email" className="mt-2 w-full rounded-md border border-zinc-700 bg-zinc-950 px-3 py-2.5 text-zinc-100 outline-none focus:border-emerald-500" /></label>
        </div>
        <label className="block text-sm text-zinc-300">Attitude towards Vortex Dynamics<select required name="attitude" defaultValue="" className="mt-2 w-full rounded-md border border-zinc-700 bg-zinc-950 px-3 py-2.5 text-zinc-100 outline-none focus:border-emerald-500"><option value="" disabled>Select one</option><option>Excited</option><option>Curious</option><option>Constructive</option><option>Unsure</option></select></label>
        <label className="block text-sm text-zinc-300">Feedback<textarea required name="feedback" rows="4" className="mt-2 w-full resize-y rounded-md border border-zinc-700 bg-zinc-950 px-3 py-2.5 text-zinc-100 outline-none focus:border-emerald-500" /></label>
        <label className="block text-sm text-zinc-300">Suggestions<textarea name="suggestions" rows="3" className="mt-2 w-full resize-y rounded-md border border-zinc-700 bg-zinc-950 px-3 py-2.5 text-zinc-100 outline-none focus:border-emerald-500" /></label>
